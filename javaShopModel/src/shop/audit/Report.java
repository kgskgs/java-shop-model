...
public class Report{
    ...
    public ArrayList<String> ReportShopEmployee(Employee employee, Date startDate, Date endDate) throws SQLException{
    ...
    public ArrayList<String> ReportAllShops(Date startDate, Date endDate)
    {
        ...
        try {
            ...
            double totaltotal = 0.0;
            for(Shop shop : shops){
                ArrayList<Employee> employees = new MySqlRepository<>(Employee.class,sqlConnection,null).GetAll(0, 1000, false);
                double total = 0.0f;
                for(Employee emp : employees){
